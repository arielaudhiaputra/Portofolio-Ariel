                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 w-full justify-center px-4 lg:px-20 gap-20">
                            <form action="">
                                <div className="mb-6">
                                    ...
                                    <input type="text" name="name" id="name" className="bg-gray-50 border border-gray-300 dark:text-white text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 " required/>
                                </div>
                                <div className="mb-6">
                                    <label htmlFor="email" className="block mb-2 text-sm font-semibold text-gray-900 dark:text-white">Email</label>
                                    <input type="text" name="email" id="email" className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 " required/>
                                </div>
                                <div className="mb-6">
                                ...
                                <button type="submit" className="text-white bg-sky-500 hover:bg-sky-600 rounded-xl px-10 py-2 text-center ">Submit</button>
                            </form>

                            <div className="flex flex-col gap-5 w-full">
                                <h1 className="font-bold text-gray-700 text-2xl md:text-3xl dark:text-white">Visit My Social Media</h1>

                                <a href="https://www.facebook.com/ariel.audhiaputra.1" className="flex flex-row py-2 px-6 rounded-lg bg-blue-500 gap-10 items-center">
                                ...
                                <a href="https://www.instagram.com/ariel_audhia/?igshid=MzRlODBiNWFlZA==" className="flex flex-row py-2 px-6 rounded-lg bg-green-500 gap-10 items-center">
